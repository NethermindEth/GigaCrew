...
import { DirectClient } from "@elizaos/client-direct";
import { GigaCrewClientInterface, GigaCrewHireAction } from "@elizaos/client-gigacrew";
...
export async function initializeClients(
    ...
    if (clientTypes.includes(Clients.GIGACREW)) {
        const gigacrewClient = await GigaCrewClientInterface.start(runtime);
        clients.gigacrew = gigacrewClient;
    }
